            ...
            <Form action="/create" method="POST"
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridFirstName">
                        ...
                        <Form.Control type="text" id="fname" name="fname" placeholder="Enter First Name" defaultValue={fname} onChange={(e) => fname = e.target.value} required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridLastName">
                        <Form.Label>Last Name</Form.Label>
                        <Form.Control type="text" id="lname" name="lname" placeholder="Enter Last Name" defaultValue={lname} onChange={(e) => lname = e.target.value} required />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridDOB">
                        ...
                        <Form.Control type="date" name="dob" id="dob" placeholder="Date of Birth" required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridEmail">
                        <Form.Label>Email</Form.Label>
                        <Form.Control type="email" id="email" name="email" placeholder="Enter Email" defaultValue={email} onChange={(e) => email = e.target.value} required />
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridCity">
                        ...
                        <Form.Control name="city" id="city" placeholder="Enter City" required />
                    </Form.Group>
                    ...
                    <Form.Group as={Col} controlId="formGridZip">
                        ...
                        <Form.Control name="zip" id="zip" placeholder="Enter 6 digit pincode" required />
                    </Form.Group>
                ...
                <Form.Row>
                    ...
                    <Form.Group as={Col} controlId="formGridPhone1">
                        ...
                        <Form.Control id="phone1" name="phone1" placeholder="eg:- 932154XXXX" defaultValue={phone} onChange={(e) => phone = e.target.value} required />
                    </Form.Group>
                ...
                <Form.Group controlId="formGridSkillDes">
                    ...
                    <Form.Control id ="desig" name="desig" type="text" placeholder="Write Designation applying for" required />
                </Form.Group>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridUnderGraduation">
                        ...
                        <Form.Control type="text" id="ugDegree" name="ugDegree" placeholder="Enter UG Course" defaultValue={ugDegree} onChange={(e) => ugDegree = e.target.value} required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridPGCollege">
                        <Form.Label>College</Form.Label>
                        <Form.Control id="ug_University" name="ug_University" type="text" placeholder="Enter UG College" defaultValue={ug_University} onChange={(e) => ug_University = e.target.value} required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridPGPercentage">
                        <Form.Label>Percentage</Form.Label>
                        <Form.Control id="ugPercentage" name="ugPercentage" type="text" placeholder="Enter UG Percentage" required />
                    </Form.Group>
                </Form.Row>
                ...
                <Form.Row>
                    <Form.Group as={Col} controlId="formGridSkill1">
                        ...
                        <Form.Control type="text" id="skills1" name="skills1" placeholder="Enter Skill" defaultValue={skills1} onChange={(e) => skills1 = e.target.value} required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridSkill2">
                        <Form.Label>Skill 2</Form.Label>
                        <Form.Control type="text" id="skills2" name="skills2" placeholder="Enter Skill" defaultValue={skills2} onChange={(e) => skills2 = e.target.value} required />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridSkill3">
                        <Form.Label>Skill 3</Form.Label>
                        <Form.Control type="text" id="skills3" name="skills3" placeholder="Enter Skill" defaultValue={skills3} onChange={(e) => skills3 = e.target.value} required />
                    </Form.Group>
                </Form.Row>
