...
export const SignUp = () => {
    ...
    return (
        <>
            <NavigationBar />
            <Container style={mainWidth} className="sign-container bg-light text-dark shadow-lg mb-5 bg-white rounde">
                <Row>
                    <Col sm={5} style={divColor} className="text-white font-weight-bold p-3 col-container-1">
                        ...
                        <div>
                            <p className="text-center">Already a User ?{" "}
                                <Link to="/Login" className="sign-link">Login Now</Link>
                            </p>
                        </div>
                    </Col>
                    <Col sm={7} className="bg-light text-dark parent-sign col-container-2">
                        <div className="child-sign">
                            <h2 className=" text-center mb-4 font-weight-bold">Sign Up Now !</h2>
                            <Form action="/auth" method="POST">
                                <Form.Group controlId="SignUpEmail">
                                    <Form.Control type="text" required placeholder="Company Name"
                                        id="company_name" name="company_name" onChange={(e) =>
                                            setCompanyName(e.target.value)} />
                                </Form.Group>
                                <Form.Group controlId="SignUpEmail">
                                    <Form.Control type="email" required placeholder=
                                        "Company Email" id="email" name="email" onChange={(e) =>
                                ...
                                <Form.Group controlId="formHorizontalPassword">
                                    <Form.Control type="password" required placeholder=
                                        "Confirm Password" id="password2" name="password2"
