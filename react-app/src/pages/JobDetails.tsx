...
const JobDetails = () => {
    ...
    return (
      ...
      <h4>Excel your Career with Us...</h4>
        ...
        <p>A software development company, with a difference. We build deep tech SAASproducts and platforms. Our experts in Analytics, Machine Learning & Integrations, build upon learnings and frameworks from a decade of launching 225+ products. We understand the process, passion and hard work it takes to launch and support a growing product.</p>
        <p>Let’s build something delightful, launch quickly and iterate to success.</p>
        </div>
        <div className="job-des-section shadow-lg">
          <h4>Opportunities with us</h4>
        {
            data.map((jobInfo)=> <Tab.Container id="left-tabs-example" defaultActiveKey="job-role">
            <Row>
              <Col sm={3}>
              ...
              <Col sm={9}>
                <Tab.Content>
                  ...
                  <p>{jobInfo.jobDes}</p>
                  <h6><b>Job Offer:</b> {jobInfo.jobOffer}</h6> 
                  <h6><b>CTC offering:</b> {jobInfo.jobCtc} LPA</h6>  
                  <h6><b>Skills Preferred:</b> </h6>
                  ...
                  <Button
                    variant="dark"
                    type="submit"
                    style={{ width: "25%", height: "3rem", marginBottom: "1rem" }}
                  >
                    Apply
                  </Button>
                  </Link>
